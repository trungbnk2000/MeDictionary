        ...
        <View style={{flex:1, backgroundColor: '#F4F5F9', justifyContent: 'space-between'}}>
            <View style={{flexDirection: 'column', padding: 25, backgroundColor: '#1479FF', height: '30%', borderBottomLeftRadius: 50, borderBottomRightRadius: 50, paddingHorizontal: 20}}>
                ...
                <View style={{height: 700}}>
                    <View style={{height: '35%', marginTop: 25, backgroundColor: '#FFF', borderRadius: 10, padding: 10}}>
                        <Image source={require('../../assets/images/DetailImage.png')} style={{borderRadius: 10, height: '100%', width: '100%'}} resizeMode='cover'/>
                    </View>
                    <View style={{flex: 1, flexDirection: 'column', margin: 10}}>
                        <Text style={{fontSize: 25, fontWeight: 'bold', color: '#36596A'}}>{data.name}</Text>
                        <Text style={{paddingTop: 10, fontSize: 18, color: '#A7AFBC'}}>Lorem Ipsum has been the industry's standard dummy text ever.</Text>
                        <View style={{flexDirection: 'row', paddingTop: 20, alignItems:'center', justifyContent: 'space-between'}}>
                            <Text style={{fontSize: 20, fontWeight: 'bold', color: '#2EC28B'}}>
                                {data.price} VNĐ
                            </Text>
                            <Text style={{fontSize: 16, color: '#A7AFBC'}}>
                                Giảm {data.discount}%
                            </Text>
